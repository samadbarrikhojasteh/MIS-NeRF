...
class VanillaPipeline(Pipeline):
    ...
    def get_eval_image_metrics_and_images(self, step: int):
        ...
        """
        self.eval()
        self.dir_file = self.datamanager.config.data
        camera, batch = self.datamanager.next_eval_image(step)
        outputs = self.model.get_outputs_for_camera(camera)
        metrics_dict, images_dict = self.model.get_image_metrics_and_images(outputs, batch, self.dir_file)
    ...
    def get_average_eval_image_metrics(
        ...
        with Progress(
            ...
            for camera, batch in self.datamanager.fixed_indices_eval_dataloader:
                ...
                metrics_dict, _ = self.model.get_image_metrics_and_images(outputs, batch, self.dir_file)
