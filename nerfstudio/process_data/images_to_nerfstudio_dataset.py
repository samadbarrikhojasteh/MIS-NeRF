...
class ImagesToNerfstudioDataset(ColmapConverterToNerfstudioDataset):
    ...
    def main(self) -> None:
        ...
        if not self.skip_image_processing:
            ...
            # if mask_path is None and self.output_dir/"masks" is not None:
            if os.path.exists(self.output_dir/"masks"):
                # camera_mask_path_list = []
                # for p in range(len(os.listdir(self.output_dir / "masks"))):
                #     sam = sorted(os.listdir((self.output_dir / "masks")))[p]
                #     camera_mask_path_list.append(Path(self.output_dir / "masks") / sam)
                mask_path = self.output_dir/"masks"
