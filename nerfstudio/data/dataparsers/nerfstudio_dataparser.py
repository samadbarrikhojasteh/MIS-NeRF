...
class Nerfstudio(DataParser):
    ...
    def _generate_dataparser_outputs(self, split="train"):
        ...
        for frame in meta["frames"]:
            ...
            fnames.append(fname)
            # add depth map into JSON file(if we had depths folder there)
            if os.path.exists(Path(data_dir/"depths")):
                frame["depth_file_path"] = str(Path("depths", os.path.basename(frame["file_path"])))
